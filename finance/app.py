...
def sell():
    ...
    db.execute("UPDATE owned SET shares = shares - ?, holding = holding - ?, balance = balance + ?, total = balance + (shares * ?) WHERE username = ?", selected_shares, selected_shares * price, selected_shares * price, price, username)
